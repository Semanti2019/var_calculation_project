    ...
    def run_handler():
        try:
            ...
            calculated_var = VaRCalculator.calculate_var(
                [
                 (ccy1_df,ConfigRiskModel.HORIZON_DAYS,ConfigRiskModel.PORTFOLIO_VALUE["ccy-1"],ReturnCalculator.log_shift),
                 (ccy2_df,ConfigRiskModel.HORIZON_DAYS,ConfigRiskModel.PORTFOLIO_VALUE["ccy-2"],ReturnCalculator.log_shift)
                 ]
            )
